...
export const Timeline = ({ data }: { data: TimelineEntry[] }) => {
  ...
  return (
    <div
      className="w-full mt-20 md:px-10"
      ref={containerRef}
    >
      <div className="max-w-7xl mx-auto py-20 px-4 md:px-8 lg:px-10">
        ...
        <p className="text-gray-400 text-sm md:text-base max-w-sm">
          Saya telah belajar menjadi web developer dari 2 tahun yang lalu.
        </p>
      </div>
      ...
      <div ref={ref} className="relative max-w-7xl mx-auto pb-20">
        ...
        >
          <motion.div
            ...
            className="absolute inset-x-0 top-0  w-[2px] bg-gradient-to-t from-200 via-100 to-transparent from-[0%] via-[10%] rounded-full"
          />
        </div>
      </div>
    </div>
